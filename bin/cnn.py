...
def create_model():
    model = Sequential([
        layers.Rescaling(1./255, input_shape=(24, 24, 1)),
...
def train():
    ...
    # 保存数据集分类
    np.save("/Users/taoliu/Documents/git/github/img2txt/checkpoint/class_name.npy", class_names)
...
if __name__ == '__main__':
    ...
    #imgs = [cv2.imread(f'/Users/taoliu/Documents/git/github/img2txt/test/img{i}.png', 0) for i in range(20, 21)]
